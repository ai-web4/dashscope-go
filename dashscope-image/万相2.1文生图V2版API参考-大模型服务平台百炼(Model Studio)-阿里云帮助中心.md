# 万相2.1文生图V2版API参考-大模型服务平台百炼(Model Studio)-阿里云帮助中心
...
请确保 DashScope Python SDK 版本不低于`1.25.7`，再运行以下代码。更新请参考 [安装SDK](https://help.aliyun.com/zh/model-studio/install-sdk)。
