万相-参考生视频-API参考-大模型服务平台百炼(Model Studio)-阿里云帮助中心
...
reference_urls直接影响费用，计费规则请参见 [计费与限流](https://help.aliyun.com/zh/model-studio/video-to-video-guide#6f5774ce5fqie)。
